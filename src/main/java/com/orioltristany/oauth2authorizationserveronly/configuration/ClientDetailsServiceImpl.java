...
public class ClientDetailsServiceImpl implements ClientDetailsService {
	...
	public ClientDetailsServiceImpl(
			@Value("${com.orioltristany.oauth2authorizationserver.accesstoken.validity}") Integer accessTokenValidity,
			@Value("${com.orioltristany.oauth2authorizationserver.refreshtoken.validity}") Integer refreshTokenValidity,
			@Value("${com.orioltristany.oauth2authorizationserver.clientid}") String clientId,
			@Value("${com.orioltristany.oauth2authorizationserver.clientsecret}") String clientSecret) {
		super();
